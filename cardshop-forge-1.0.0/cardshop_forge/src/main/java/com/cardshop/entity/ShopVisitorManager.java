...
import com.cardshop.block.ShopRankManager;
...
public class ShopVisitorManager {
    ...
    public static void onServerTick(ServerLevel world) {
        ...
        world.blockEntityTicking.forEach(bte -> {
            if (bte.blockEntity instanceof ShopStandBlockEntity be)
                trySpawn(world, bte.pos, be);
        });
    }
